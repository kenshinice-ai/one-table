...
![Landscape iPad concept](./renders/ipad-filter-workspace.png)
...
![Mobile filter concept](./renders/mobile-filter-workspace.png)
...
![Mobile result concept](./renders/mobile-menu-result.png)
