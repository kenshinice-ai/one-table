/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 294236dcf6cae8ca280ed559eead7e5f)
...
interface __BaseEnv_CloudflareEnv {
  ...
  APP_BASE_URL: 'https://staging.example.com' | 'https://example.com' | 'http://localhost:3000';
}
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, 'APP_ENV' | 'APP_BASE_URL'>> {}
}
