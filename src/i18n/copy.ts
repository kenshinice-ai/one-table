...
export const copy = {
  'zh-CN': {
    ...
    inSeason: '当季',
    kioskStart: '碰一下开始',
    kioskStartHint: '选一道菜，直接配好这一桌',
    kioskTake: '扫码带走这桌菜',
    kioskTakeHint: '手机相机对准二维码，这桌菜就在你手上',
    kioskExit: '重新开始',
    qrFallback: '若相机无法识别，请到服务台出示本页',
  },
  'en-AU': {
    brand: 'One Table',
    brandLatin: 'YÌ ZHUŌ',
    ...
    inSeason: 'Now',
    kioskStart: 'Touch to start',
    kioskStartHint: 'Pick a dish and the rest of the table follows',
    kioskTake: 'Scan to take this table with you',
    kioskTakeHint: 'Point your camera at the code and the table is on your phone',
    kioskExit: 'Start again',
    qrFallback: 'If your camera cannot read it, show this screen at the concierge desk',
  },
} as const;
