...
export const names: Record<string, { zh: string; en: string }> = {
  ...
  cny: { zh: '春节家宴', en: 'Lunar New Year' },
  mid_autumn: { zh: '中秋赏月', en: 'Mid-Autumn' },
  christmas: { zh: '圣诞聚餐', en: 'Christmas' },
  easter: { zh: '复活节', en: 'Easter' },
  brunch: { zh: '周末早午餐', en: 'Weekend brunch' },
  afternoon_tea: { zh: '下午茶', en: 'Afternoon tea' },
...
export const copy = {
  'zh-CN': {
    ...
    conciergeFinishStop: '买齐后可寄存在这里，先逛后取',
    saveRouteCard: '保存路线卡',
    ...
    occasion: '场合',
    seasonal: '当季',
    seasonalHint: '一键换成这个场合的一桌，再点一次取消。',
    inSeason: '当季',
    kioskStart: '轻触屏幕，开始配菜',
    kioskStartHint: '就从这道菜开始，一整桌菜单一次配好',
    kioskTake: '扫码带走这桌菜',
    kioskTakeHint: '用手机相机对准二维码，菜单和购物清单一起带走',
    qrFallback: '扫不出来？把手机靠近一些，或请店员协助。',
  },
  'en-AU': {
    brand: 'One Table',
    brandLatin: 'YÌ ZHUŌ',
    ...
    conciergeFinishStop: 'Leave your shopping here and keep going',
    ...
    occasion: 'Occasion',
    seasonal: 'In season',
    seasonalHint: 'One tap lays the table for that occasion; tap again to undo.',
    inSeason: 'Now',
    kioskStart: 'Touch the screen to start',
    kioskStartHint: 'Start from this dish and the whole table follows',
    kioskTake: 'Scan to take this table with you',
    kioskTakeHint: 'Point your camera at the code — menu and shopping list, both',
    qrFallback: 'Not scanning? Move your phone closer, or ask a staff member.',
  },
} as const;
